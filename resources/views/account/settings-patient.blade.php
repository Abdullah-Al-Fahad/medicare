...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Patient Settings') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('account.update') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="location" type="text" class="form-control @error('location') is-invalid @enderror" name="location" value="{{ old('location', $user->patient->location) }}" required autocomplete="location">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="dob" type="date" class="form-control @error('dob') is-invalid @enderror" name="dob" value="{{ old('dob', $user->patient->dob) }}" required autocomplete="dob">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="sex" class="form-control @error('sex') is-invalid @enderror" name="sex" required autocomplete="sex">
